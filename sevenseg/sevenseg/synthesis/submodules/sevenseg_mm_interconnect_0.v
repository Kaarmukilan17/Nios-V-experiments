...
`timescale 1 ps / 1 ps
module sevenseg_mm_interconnect_0 (
	...
	wire    [5:0] cmd_mux_001_src_channel;                                              // cmd_mux_001:src_channel -> intel_niosv_m_0_dm_agent_agent:cp_channel
	...
	wire          cmd_mux_003_src_valid;                                                // cmd_mux_003:src_valid -> switch_pio_s1_agent:cp_valid
	wire  [105:0] cmd_mux_003_src_data;                                                 // cmd_mux_003:src_data -> switch_pio_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                // switch_pio_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                              // cmd_mux_003:src_channel -> switch_pio_s1_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                        // cmd_mux_003:src_startofpacket -> switch_pio_s1_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                          // cmd_mux_003:src_endofpacket -> switch_pio_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                // cmd_mux_004:src_valid -> hex0_pio_s1_agent:cp_valid
	wire  [105:0] cmd_mux_004_src_data;                                                 // cmd_mux_004:src_data -> hex0_pio_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                // hex0_pio_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                              // cmd_mux_004:src_channel -> hex0_pio_s1_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                        // cmd_mux_004:src_startofpacket -> hex0_pio_s1_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                          // cmd_mux_004:src_endofpacket -> hex0_pio_s1_agent:cp_endofpacket
	...
	wire          switch_pio_s1_agent_rp_valid;                                         // switch_pio_s1_agent:rp_valid -> router_007:sink_valid
	wire  [105:0] switch_pio_s1_agent_rp_data;                                          // switch_pio_s1_agent:rp_data -> router_007:sink_data
	wire          switch_pio_s1_agent_rp_ready;                                         // router_007:sink_ready -> switch_pio_s1_agent:rp_ready
	wire          switch_pio_s1_agent_rp_startofpacket;                                 // switch_pio_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          switch_pio_s1_agent_rp_endofpacket;                                   // switch_pio_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          hex0_pio_s1_agent_rp_valid;                                           // hex0_pio_s1_agent:rp_valid -> router_008:sink_valid
	wire  [105:0] hex0_pio_s1_agent_rp_data;                                            // hex0_pio_s1_agent:rp_data -> router_008:sink_data
	wire          hex0_pio_s1_agent_rp_ready;                                           // router_008:sink_ready -> hex0_pio_s1_agent:rp_ready
	wire          hex0_pio_s1_agent_rp_startofpacket;                                   // hex0_pio_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          hex0_pio_s1_agent_rp_endofpacket;                                     // hex0_pio_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          hex0_pio_s1_agent_rdata_fifo_out_valid;                               // hex0_pio_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] hex0_pio_s1_agent_rdata_fifo_out_data;                                // hex0_pio_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          hex0_pio_s1_agent_rdata_fifo_out_ready;                               // avalon_st_adapter_004:in_0_ready -> hex0_pio_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                    // avalon_st_adapter_004:out_0_valid -> hex0_pio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                     // avalon_st_adapter_004:out_0_data -> hex0_pio_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                    // hex0_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                    // avalon_st_adapter_004:out_0_error -> hex0_pio_s1_agent:rdata_fifo_sink_error
	...
	sevenseg_mm_interconnect_0_router router (
	...
	sevenseg_mm_interconnect_0_router router_001 (
	...
	sevenseg_mm_interconnect_0_router_002 router_002 (
	...
	sevenseg_mm_interconnect_0_router_002 router_003 (
	...
	sevenseg_mm_interconnect_0_router_004 router_004 (
	...
	sevenseg_mm_interconnect_0_router_005 router_005 (
	...
	sevenseg_mm_interconnect_0_router_005 router_006 (
	...
	sevenseg_mm_interconnect_0_router_004 router_007 (
	...
	sevenseg_mm_interconnect_0_router_004 router_008 (
	...
	sevenseg_mm_interconnect_0_router_004 router_009 (
	...
	sevenseg_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_cmd_demux_002 cmd_demux_002 (
		.clk                (clk_0_clk_clk),                                                        //        clk.clk
		.reset              (intel_niosv_m_0_reset_reset_bridge_in_reset_reset),                    //  clk_reset.reset
	...
	sevenseg_mm_interconnect_0_cmd_demux_002 cmd_demux_003 (
		.clk                (clk_0_clk_clk),                                                        //        clk.clk
		.reset              (intel_niosv_m_0_reset_reset_bridge_in_reset_reset),                    //  clk_reset.reset
	...
	sevenseg_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                     //       clk.clk
		.reset               (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                     //       clk.clk
		.reset               (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                     //       clk.clk
		.reset               (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                     //       clk.clk
		.reset               (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                     //       clk.clk
		.reset               (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                     //       clk.clk
		.reset               (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                     //       clk.clk
		.reset              (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                     //       clk.clk
		.reset               (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                     //       clk.clk
		.reset               (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_rsp_mux_002 rsp_mux_002 (
		.clk                 (clk_0_clk_clk),                                     //       clk.clk
		.reset               (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_rsp_mux_002 rsp_mux_003 (
		.clk                 (clk_0_clk_clk),                                     //       clk.clk
		.reset               (intel_niosv_m_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sevenseg_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
