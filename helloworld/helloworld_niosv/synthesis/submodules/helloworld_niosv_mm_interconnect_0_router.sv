...
module helloworld_niosv_mm_interconnect_0_router_default_decode
  #(
...
module helloworld_niosv_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    helloworld_niosv_mm_interconnect_0_router_default_decode the_default_decode(
