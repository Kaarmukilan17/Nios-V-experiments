...
module pushbutton_mm_interconnect_0_router_default_decode
  #(
...
module pushbutton_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    pushbutton_mm_interconnect_0_router_default_decode the_default_decode(
